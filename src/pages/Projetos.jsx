            ...
            <div className="flex flex-col items-center font-semibold gap-4 bg-white py-8 px-4 rounded-lg shadow-md hover:scale-105 duration-200">
              ...
              <div className="flex flex-col gap-2">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="bg-zinc-400 rounded-lg flex items-center justify-center gap-1 text-zinc-50 font-semibold py-1 hover:bg-zinc-500 shadow-md text-sm hover:scale-105 duration-200"
                >
