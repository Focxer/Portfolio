...
function Linguagens() {
  return (
    <>
      <div className="bg-zinc-50 shadow-lg rounded-b-lg pb-4 hover:cursor-default">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 p-4">
          ...
          <div className="init-hidden flex flex-col items-center gap-4 bg-white p-8 rounded-lg shadow-md hover:scale-105 duration-150">
            <img
              src={php}
              alt="PHP icon"
              className="p-2 w-full h-full max-w-[96px] max-h-[96px]"
            />
            <p>
          ...
          <div className="init-hidden flex flex-col items-center gap-2 bg-white p-8 rounded-lg shadow-md hover:scale-105 duration-150 mt-1">
            <img
              src={react}
              alt="React icon"
              className="p-2 w-full h-full max-w-[96px] max-h-[96px]"
