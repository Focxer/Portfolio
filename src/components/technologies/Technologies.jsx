...
const Technologies = () => {
  const technologies = [
    ...
    },
    {
      icon: css,
      title: "CSS 3",
      text: "Layout consistente e agradável aos olhos, utilizando CSS puro ou algum framework como Tailwind, Bootstrap, entre outros.",
      color: "text-[#35c1f1]",
      alt: "CSS 3",
    },
    {
      icon: javascript,
      title: "JavaScript",
      text: "POO, testes unitários com Jest, manipulação de DOM e clean code para manter o código sempre bem organizado, reaproveitável e com menos chances de bugs.",
      color: "text-[#ffd600]",
      alt: "JavaScript",
    },
    {
    ...
    },
    {
      icon: php,
      title: "PHP",
      text: "Minha primeira linguagem backend, conhecimento básico e prático de operações de banco de dados, queries simples com MySQL e aplicação fullstack.",
      color: "text-[#b6a8c8]",
      alt: "PHP",
    },
    {
